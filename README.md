...
The canvas is infinite. Pan with the trackpad, scroll wheel, or middle-mouse drag (like Figma). Zoom with pinch gestures or `Cmd+Scroll`. Double-click empty space to zoom to fit all terminals.
